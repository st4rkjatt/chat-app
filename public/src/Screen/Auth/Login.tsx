...
import { userLoginApi } from "../../reduxToolkit/Reducers/Auth.tsx/UserLoginSlice";
...
const Login = () => {
  ...
  const result = useSelector((state: RootState) => state.userAuth);
...
// console.log(params,"paramss")
  ...
  const handleGoogleSignIn = async () => {
    ...
    window.location.href = "http://localhost:13000/login/google";
   
  };
  
  // dispatch(userLoginByGoogleApi())
