...
import { UserRegisterApi } from "../../reduxToolkit/Reducers/Auth.tsx/UserLoginSlice";
...
const Registration = () => {
  ...
  const result:any = useSelector((state: RootState) => state.userAuth);
  ...
  const handleSubmit = (e:any) => {
    ...
    if (form.password.length < 6) {
      return toast.error("Password must be greater than 6 letter.");
    }
    if (form.c_password !== form.password) {
      return toast.error("Password did't match.");
    }
    dispatch(UserRegisterApi(form));
  };
  ...
  const handleGoogleSignIn = () => {
    ...
    window.location.href = "http://localhost:13000/auth/google";
  };
  return (
    <>
      <ToastContainer />
      <section className="h-screen">
        <div className="h-full">
          ...
          <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-center ">
            ...
            <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12 border p-5 rounded-lg">
              <form onSubmit={handleSubmit}>
                {/*Sign in section*/}
                <div className="flex flex-row items-center justify-center lg:justify-start">
                  <p className="mb-0 mr-4 text-lg">Sign Up in with</p>
                  {/* Facebook */}
                  {/* <Link to="http://localhost:5173/auth/google"> */}
                  <button
                    type="button"
                    data-te-ripple-init
